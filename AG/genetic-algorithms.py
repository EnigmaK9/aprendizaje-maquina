...
pobBin.append(h1)
pobBin.append(h2)
pobDec.append([int("".join(str(x) for x in h1[0]), 2), int("".join(str(x) for x in h1[1]), 2), int("".join(str(x) for x in h1[2]), 2), int("".join(str(x) for x in h1[3]), 2)])
pobDec.append([int("".join(str(x) for x in h2[0]), 2), int("".join(str(x) for x in h2[1]), 2), int("".join(str(x) for x in h2[2]), 2), int("".join(str(x) for x in h2[3]), 2)])
...
pobBin[i][j][gen]=0
pobDec[i]=[int("".join(str(x) for x in pobBin[i][0]), 2), int("".join(str(x) for x in pobBin[i][1]), 2), int("".join(str(x) for x in pobBin[i][2]), 2), int("".join(str(x) for x in pobBin[i][3]), 2)]
...
print('Mejor solución en binario: {}'.format(pobBin[listaEvaluacion.index(max(listaEvaluacion))]))
print('Mejor solución en decimal: {}'.format(pobDec[listaEvaluacion.index(max(listaEvaluacion))]))
